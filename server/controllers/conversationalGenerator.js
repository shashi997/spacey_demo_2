...
const generateConversationalResponse = async ({
  ...
  let prompt = `
You are Spacey, an AI mission guide and tutor aboard the Mars Base Ares-X. Your role is to provide personalized, insightful, and encouraging feedback to the student, whom you will address as "Commander". Your tone is calm, supportive, and professional, with a hint of wit. You are guiding them through the "${lessonData.title}" mission.
...
--- YOUR TASK ---
Based on the block type and all the context above, generate a short, natural, conversational response (2-4 sentences) for the Commander.
`;

  // 2. Add task-specific instructions based on the block type
